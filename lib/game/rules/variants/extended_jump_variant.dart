...
/// Extended jump variant implementation
/// In this variant:
/// - Leopards can also jump horizontally like lions/tigers
/// - Lions can jump over double rivers
class ExtendedJumpVariant implements GameRuleVariant {
  final GameRuleVariant _baseVariant;

  ExtendedJumpVariant(this._baseVariant);
  ...
  bool canJumpOverRiver(
    ...
    // If extended jump variant is not enabled, delegate to base variant
    ...
    if (from.row == to.row) {
      ...
      // Standard horizontal jump for Lion/Tiger/Leopard (over 2 river cells)
    ...
    // Delegate to base variant for other cases
    return _baseVariant.canJumpOverRiver(from, to, piece, board, gameConfig);
  }
